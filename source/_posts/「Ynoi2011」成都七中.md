...
对第一棵树进行 DSU on tree，维护第一棵子树内的点在第二棵树上的信息。现在还要考虑颜色去重的问题，对于一个颜色 $c$，若其在第二棵树上有 $x_1, x_2, \dots, x_k$ 这些点，那么颜色 $c$ 会对**这些点到根节点的树链并**有 $1$ 的贡献。有一个经典的树上差分做法：将 $x_1, x_2, \dots, x_k$ 按照 dfs 序排序。
